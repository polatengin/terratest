...
how you can use Terratest to write automated tests for your Azure Terraform code. This module deploys a [Resource Group](https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/manage-resource-groups-portal) and gives that Resource Group a `Name` tag with the value specified in by the `prefix`-`resourceGroupName` variables.

Check out [test/terraform_azure_resourcegroup_example_test.go](/test/terraform_azure_resourcegroup_example_test.go) to see how you can write
automated tests for this module.

Note that the Resource Group in this module doesn't actually do anything; it just creates the resource for demonstration purposes. For slightly more complicated, real-world examples of Terraform modules, see
