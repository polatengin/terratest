...
how you can use Terratest to write automated tests for your Azure Terraform code. This module deploys an [Azure Storage
Account](https://azure.microsoft.com/en-us/services/storage/) and gives that storage account a randomized 8 character`Name` with value output in the `storage_account_name` terraform output variable.

Check out [test/terraform_azure_storage_example_test.go](/test/terraform_azure_storage_example_test.go) to see how you can write
automated tests for this module.

Note that the storage account in this module deploys an Azure Blob container with the name `container1` used in certain verification tests in the sample.
...
[System.Environment]::SetEnvironmentVariable("ARM_TENANT_ID","AzurePublicCloud",[System.EnvironmentVariableTarget]::Machine)
```